...
def run_performance_tests():
    ...
    medium_text = (
        "Medical nexus letter " * 50
        + " regarding veteran disability service connection and medical opinion assessment"
    )
    long_text = (
        "This is a comprehensive medical nexus letter regarding veteran disability service connection. "
        * 100
        + "Medical opinion provided by qualified physician regarding service-connected condition."
    )
